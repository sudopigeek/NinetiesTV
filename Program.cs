...
namespace NinetiesTV
{
    class Program
    {
        ...
        **************************************************************************************************/
        ...
        {
            return shows.Select(s => s.Name).OrderBy(x => x).ToList();
        }
        ...
        {
            return shows.OrderBy(x => x.ImdbRating).ToList();
        }
        ...
        {
            return shows.Where(s1 => s1.EpisodeCount < 100).Select(s => s.Name).ToList();
        }
